...
class Verstappen(Driver):
    ...
    def move_offensive(self): # This is an example of a method that implements the abstract method
        return self.move_selector("offensive")
    
    def move_defensive(self): # This is the method that will be used to select the defensive move
        return self.move_selector("defensive")
    
    def move_selector(self, move_type): # This is the method that will be used to select the move
